        ...
        <Link to={`/products/${product.slug}`} className="block">
          <div className="relative aspect-[4/5] overflow-hidden rounded-[1.55rem] bg-gradient-to-br from-stone-100 via-white to-amber-50">
            ...
            <div className="absolute right-4 top-4 flex flex-col gap-2 opacity-0 transition duration-300 group-hover:opacity-100">
              ...
              <span className="grid h-10 w-10 place-items-center rounded-full border border-white/25 bg-black/35 text-white backdrop-blur-xl transition hover:bg-black/55">
                <Eye size={17} />
              </span>
            </div>
          </div>
