      ...
      <div className="border-b border-vjj-champagne bg-vjj-cream px-7 py-6">
        <div className="flex flex-col justify-between gap-5 md:flex-row md:items-start">
          ...
          <div className="rounded-3xl bg-vjj-black px-5 py-4 text-right text-vjj-champagne">
            ...
            <p className="mt-1 text-xs font-semibold capitalize text-vjj-champagne/70">
          ...
          <table className="w-full min-w-[980px] border-collapse text-left text-xs">
            ...
            <tbody>
              {items.map((item, index) => (
                <tr
                  key={`${item.productName}-${item.sku}-${index}`}
                ...
                >
                  ...
                  <TableCell>{formatCurrency(item.stoneValue)}</TableCell>
                  <TableCell>
